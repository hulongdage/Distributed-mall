...
<!--页面顶部 开始-->
<#include "head.ftl" encoding="GB2312">
<#--图片列表 -->
					...
					<div class="clearfix choose">
						...
						<#list specificationList as specification>
							<dl>
								...
								<dd><a href="javascript:;" class="{{isSelected('${specification.attributeName}','${item}')?'selected':''}}" ng-click="selectSpecification('${specification.attributeName}','${item}')">${item}</a></dd>
								</#list>
							</dl>
							</#list>
						</div>
